    ...
    return (
        <div className="items-center">
            <div className="flex justify-center">
                <a href='https://ulefone.com.co/?gad_source=1&gclid=CjwKCAiA-ty8BhA_EiwAkyoa3wqdtfbAo4goLrUBlfddtpXx8K9nMyC_J3tVn5dyPF1O66GowGf2RBoC7HIQAvD_BwE'><img className="rounded-3xl shadow-2xl scale-95 transition-transform duration-300 hover:scale-110" src={Ulefone} width={300} height={50}/></a>
            </div>
