...
import { HomeIcon, DatacenterIcon, ToolIcon, SellerIcon, LearnIcon, AccountingIcon } from '@/Components/icons/Icons'
  ...
  return (
    <div id='app2' className='min-h-screen bg-gray-100 gap-2'>
      ...
      <Sidebar user={user} className='[grid-area:aside] max-w-xs'>
        ...
        <SidebarItem icon={<LearnIcon alt="Student Icon" size='32px' color='#395181'/>} href={route('modulo.index')} text='Cursos y Capacitaciones' />
